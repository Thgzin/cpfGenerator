...
}`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AACA;EACE,iCAAiC;EACjC,sCAAsC;AACxC;;AAEA;EACE,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,SAAS;EACT,UAAU;EACV,gCAAgC;EAChC,oCAAoC;EACpC,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,gBAAgB;EAChB,aAAa;EACb,mBAAmB;AACrB;;;AAGA;EACE,kBAAkB;EAClB,mBAAmB;AACrB;;AAEA;AACA,kBAAkB;AAClB,cAAc;AACd,mBAAmB;AACnB,iBAAiB;AACjB,2BAA2B;AAC3B,mBAAmB;AACnB;;AAEA;EACE,cAAc;EACd,cAAc;EACd,YAAY;EACZ,gBAAgB;EAChB,mBAAmB;EACnB,yCAAyC;EACzC,qCAAqC;EACrC,YAAY;EACZ,aAAa;EACb,eAAe;AACjB;AACA;EACE,4BAA4B;EAC5B,6CAA6C;AAC/C","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap');\n:root {\n  --primary-color: rgb(17, 86, 102);\n  --primary-color-darker: rgb(9, 48, 56);\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-family: 'Open sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\n.container {\n  max-width: 640px;\n  margin: 50px auto;\n  background: #fff;\n  padding: 20px;\n  border-radius: 10px;\n}\n\n\n.container h1 {\n  text-align: center;\n  margin-bottom: 40px;\n}\n\n.cpf-gerado{\ntext-align: center;\nfont-size: 2em;\nletter-spacing: 2px;\nfont-weight: bold;\ncolor: var(--primary-color);\nmargin-bottom: 40px;\n}\n\n.button{\n  display: block;\n  margin: 0 auto;\n  border: none;\n  font-size: 1.3em;\n  border-radius: 20px;\n  font-family: Arial, Helvetica, sans-serif;\n  background-color:var(--primary-color);\n  color: white;\n  padding: 15px;\n  cursor: pointer;\n}\n.button:hover{\n  transition: all 500ms linear;\n  background-color: var(--primary-color-darker);\n}"],"sourceRoot":""}]);
// Exports
